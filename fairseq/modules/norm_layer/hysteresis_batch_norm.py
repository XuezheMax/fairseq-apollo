...
class HysteresisBatchNorm(nn.Module):
    def __init__(self, num_features, eps=1e-5, affine=True, momentum=0.1, hysteresis=0.5, process_group=None):
        super().__init__()
    ...
    def extra_repr(self) -> str:
        return 'num_features={num_features}, eps={eps}, affine={affine}, momentum={momentum}, hysteresis={hysteresis}'.format(**self.__dict__)
