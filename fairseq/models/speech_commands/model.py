...
def base_architecture(args):
    ...
    args.encoder_hidden_dim = getattr(args, 'encoder_hidden_dim', 90)
    ...
    args.truncation_length = getattr(args, 'truncation_length', 2000)
...
def mega_lra_sc_big(args):
    ...
    args.encoder_hidden_dim = getattr(args, 'encoder_hidden_dim', 108)
