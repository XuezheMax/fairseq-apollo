...
class MegaEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.final_norm = TimeLayerNorm(embed_dim, affine=norm_affine, eps=args.norm_eps, causal=False)
...
class MegaDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        norm_affine = not args.no_affine_norm
        self.final_norm = TimeLayerNorm(embed_dim, affine=norm_affine, eps=args.norm_eps, causal=True)
